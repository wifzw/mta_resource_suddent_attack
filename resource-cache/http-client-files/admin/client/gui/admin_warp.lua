...
function aPlayerWarp ( player )
	if ( aWarpForm == nil ) then
		...
		aWarpForm		= guiCreateWindow ( x / 2 - 110, y / 2 - 150, 200, 300, "..:: Teleportar jogador ::..", false )
		aWarpList		= guiCreateGridList ( 0.03, 0.08, 0.94, 0.73, true, aWarpForm )
		guiSetProperty(aWarpForm, "CaptionColour", "FF00ffff")
		guiSetFont ( aWarpList, "default-bold-small" )
					   guiGridListAddColumn( aWarpList, "Jogador", 0.9 )
		aWarpSelect		= guiCreateButton ( 0.03, 0.82, 0.94, 0.075, "Selecionar", true, aWarpForm )
			guiSetProperty(aWarpSelect, "NormalTextColour", "FF00FFFF")	
		aWarpCancel		= guiCreateButton ( 0.03, 0.90, 0.94, 0.075, "Cancelar", true, aWarpForm )
			guiSetProperty(aWarpCancel, "NormalTextColour", "FF00FFFF")	
