...
function aPlayerInterior ( player )
	if ( aInteriorForm == nil ) then
		...
		aInteriorForm		= guiCreateWindow ( x / 2 - 110, y / 2 - 150, 220, 300, "..:: Selecionar Interior ::..", false )
		guiSetProperty(aInteriorForm, "CaptionColour", "FF00ffff") 
		aInteriorList		= guiCreateGridList ( 0.03, 0.08, 0.94, 0.73, true, aInteriorForm )
					   guiGridListAddColumn( aInteriorList, "Interiores", 0.2 )
					   guiGridListAddColumn( aInteriorList, ":", 0.75 )
		aInteriorSelect		= guiCreateButton ( 0.03, 0.82, 0.94, 0.075, "Selecionar", true, aInteriorForm )
				guiSetProperty(aInteriorSelect, "NormalTextColour", "FF00FFBB")
		aInteriorCancel		= guiCreateButton ( 0.03, 0.90, 0.94, 0.075, "Cancelar", true, aInteriorForm )
				guiSetProperty(aInteriorCancel, "NormalTextColour", "FF00FFBB")
