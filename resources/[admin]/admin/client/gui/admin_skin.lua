...
function aPlayerSkin ( player )
	if ( aSkinForm == nil ) then
		...
		aSkinForm		= guiCreateWindow ( x / 2 - 140, y / 2 - 125, 280, 250, "..:: Selecionar skin::..", false )
				guiSetProperty(aSkinForm, "CaptionColour", "FF00ffff") 
		aSkinLabel		= guiCreateLabel ( 0.03, 0.09, 0.94, 0.07, "Selecione uma skin ou digite o id", true, aSkinForm )
					  guiLabelSetHorizontalAlign ( aSkinLabel, "center" )
		guiSetFont ( aSkinLabel, "default-bold-small" )	
					  guiLabelSetColor ( aSkinLabel, 255, 255, 0 )
		aSkinGroups		= guiCreateCheckBox ( 0.03, 0.90, 0.70, 0.09, "Ordenar por grupos", false, true, aSkinForm )
				guiSetFont ( aSkinGroups, "default-bold-small" )
		guiSetProperty(aSkinGroups, "NormalTextColour", "FFFF0000")
		...
		guiSetFont ( aSkinID, "default-bold-small" )
					  guiEditSetMaxLength ( aSkinID, 3 )
		aSkinAccept		= guiCreateButton ( 0.75, 0.28, 0.27, 0.09, "Aplicar", true, aSkinForm, "setskin" )
					guiSetProperty(aSkinAccept, "NormalTextColour", "FF00FFFF")	
		aSkinCancel		= guiCreateButton ( 0.75, 0.88, 0.27, 0.09, "Fechar", true, aSkinForm )
					guiSetProperty(aSkinCancel, "NormalTextColour", "FF00FFFF")	
